...
import com.rootbox.rootboxota.http.HttpStringReader.HttpStringReaderListener;
import com.rootbox.rootboxota.http.URLStringReader.URLStringReaderListener;
...
public abstract class Updater implements URLStringReaderListener, HttpStringReaderListener  {
    ...
    public static final String PROPERTY_VERSION_ROOTBOX = "ro.rootbox.build";
    public static final String PROPERTY_VERSION_ROOTBOX_OLD = "ro.goo.version";
